...
public class ImageSelectionActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean fromExit = receivedIntent.getBooleanExtra(GamePlayActivity.EXTRA_FROMGAMEPLAY,
                false);
        ...
        if (gameOpen && !fromExit) {
            // Resume the game
            Intent intent = new Intent(ImageSelectionActivity.this, GamePlayActivity.class);
            ...
            // Make the image list
            ImageList adapter = new ImageList(ImageSelectionActivity.this, imageId);
